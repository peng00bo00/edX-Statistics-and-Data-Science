...
class NeuralNetwork():
    ...
    def train(self, x1, x2, y):
        ...
        db  = dz1
        dW1 = dz1 @ input_values.T

        # Use gradients to adjust weights and biases using gradient descent
        lr = self.learning_rate
        self.biases = self.biases - lr * db # TODO
        self.input_to_hidden_weights = self.input_to_hidden_weights - lr * dW1 # TODO
        self.hidden_to_output_weights= self.hidden_to_output_weights - lr * dW2 # TODO
