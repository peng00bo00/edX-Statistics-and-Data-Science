...
def hinge_loss_single(feature_vector, label, theta, theta_0):
    ...
    """
    # Your code here
    loss = 1 - label * (theta @ feature_vector + theta_0)
...
def classifier_accuracy(
    ...
    y_val = classify(val_feature_matrix, theta, theta_0)
    
    return accuracy(y_train, train_labels), accuracy(y_val, val_labels)
#pragma: coderesponse end
...
# def bag_of_words(texts, stopwords=False):
#     stop = []
#     if stopwords:
#         with open("./stopwords.txt", "r") as file:
#             stop = file.readlines()
#             stop = [word.rstrip() for word in stop]
